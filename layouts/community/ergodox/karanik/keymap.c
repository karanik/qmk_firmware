...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LALT,        KC_GRV,       KC_QUOT,_______, _______,
                                              KC_LGUI, ALL_T(KC_NO),
                                                              KC_HOME,
                                               KC_BSPC,KC_DELT,KC_END,
        // right hand
             KC_RBRC,     KC_6,   KC_7,    KC_8,    KC_9,   KC_0,             KC_MINS,
             TT(SYMB),    KC_Y,   KC_U,    KC_I,    KC_O,   KC_P,             KC_EQL,
 ...
 * |        |      |      |      |      |      |      |           |      |      |      |      |      |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      | Lclk | Rclk |                                       | Prev |VolUp |VolDn | Next | Mute |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        |      |      |       |      |      |
 *                                 ,------|------|------|       |------+------+------.
...
[MDIA] = LAYOUT_ergodox(
    ...
    // right hand
       ...
       KC_TRNS,  KC_TRNS, KC_TRNS, _______, _______, KC_TRNS, KC_TRNS,
                          KC_MPRV, KC_VOLU, KC_VOLD, KC_MNXT, KC_MUTE,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
