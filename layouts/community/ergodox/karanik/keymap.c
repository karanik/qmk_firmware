...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LALT,          LGUI_T(KC_GRV),  KC_QUOT,  LALT_T(KC_EQL),   KC_MINS,  
                                                     KC_LGUI,  ALL_T(KC_NO),
                                                               KC_APP,
        ...
        // right hand
             ...
             TT(SYMB),    KC_N,   KC_M,    KC_COMM, KC_DOT, KC_UP,            KC_RSFT,
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS, KC_PGUP, KC_HOME,  KC_UP,    KC_END,     KC_F11,    KC_F12,
                KC_PGDN, KC_LEFT,  KC_DOWN,  KC_RIGHT,   KC_PAST,   KC_TRNS,
       KC_TRNS, KC_AMPR, KC_TRNS,  KC_INS,   KC_TRNS,     KC_PGUP,   KC_TRNS,
