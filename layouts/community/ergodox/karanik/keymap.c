 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | LAlt |  `~  |  '"  |  =+  | -_   |                                      | Left | Right |  Up  | Down | RCtrl |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | LWin | Hyper|       | Home | End  |
 *                                 ,------|------|------|       |------+------+------.
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LALT,        KC_GRV,       KC_QUOT,KC_EQL, KC_MINS,
                                              KC_LGUI, ALL_T(KC_NO),
                                                              KC_APP,
                                               KC_SPC,KC_DELT,KC_RALT,
        // right hand
             ...
             TT(MDIA),    KC_N,   KC_M,    KC_COMM, KC_DOT, KC_SLSH,          KC_RSFT,
                                  KC_LEFT, KC_RIGHT, KC_UP, KC_DOWN,          KC_RCTRL,
             KC_HOME, KC_END,
             KC_PGUP,
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS, KC_PGUP, KC_HOME,  KC_UP,   KC_END, KC_ASTR, KC_F11,
                KC_PGDN, KC_LEFT,  KC_DOWN, KC_RIGHT, KC_PLUS, KC_F12,
